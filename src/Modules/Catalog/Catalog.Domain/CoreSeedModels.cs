...
public static class CoreSeedModels
{
    ...
    public static class Authors
    {
        public static Author[] Create(long ticks = 0) =>
            [.. new[]
            {
                Author.Create(PersonFormalName.Create(["Martin", "Fowler"], string.Empty, string.Empty), "Martin Fowler is a British software developer, author and international public speaker on software development, specializing in object-oriented analysis and design, UML, patterns, and agile software development methodologies, including extreme programming."),
                Author.Create(PersonFormalName.Create(["Robert", "C.", "Martin"], string.Empty, string.Empty), "Robert C. Martin, colloquially called 'Uncle Bob', is an American software engineer, instructor, and best-selling author. He is most recognized for developing many software design principles and for being a founder of the influential Agile Manifesto."),
                Author.Create(PersonFormalName.Create(["Eric", "Evans"], string.Empty, string.Empty), "Eric Evans is a thought leader in software design and domain modeling. He is the author of 'Domain-Driven Design: Tackling Complexity in the Heart of Software'."),
                Author.Create(PersonFormalName.Create(["Gregor", "Hohpe"], string.Empty, string.Empty), "Gregor Hohpe is a software architect and author known for his work on enterprise integration patterns and cloud computing."),
                Author.Create(PersonFormalName.Create(["Sam", "Newman"], string.Empty, string.Empty), "Sam Newman is a technologist and consultant specializing in cloud computing, continuous delivery, and microservices."),
                Author.Create(PersonFormalName.Create(["Vaughn", "Vernon"], string.Empty, string.Empty), "Vaughn Vernon is a software developer and architect with more than 35 years of experience in a broad range of business domains."),
                Author.Create(PersonFormalName.Create(["Neal", "Ford"], string.Empty, string.Empty), "Neal Ford is a software architect, programmer, and author. He is an internationally recognized expert on software development and delivery, especially in the intersection of agile engineering techniques and software architecture."),
                Author.Create(PersonFormalName.Create(["Mark", "Richards"], string.Empty, string.Empty), "Mark Richards is an experienced, hands-on software architect involved in the architecture, design, and implementation of microservices architectures, service-oriented architectures, and distributed systems."),
                Author.Create(PersonFormalName.Create(["Dino", "Esposito"], string.Empty, string.Empty), "Dino Esposito is a well-known web development expert and the author of many popular books on ASP.NET, AJAX, and JavaScript."),
                Author.Create(PersonFormalName.Create(["Len", "Bass"], "Dr.", string.Empty), "Len Bass is a senior principal researcher at National ICT Australia Ltd. He has authored numerous books and articles on software architecture, programming, and product line engineering."),
                Author.Create(PersonFormalName.Create(["Erich", "Gamma"], "Dr.", string.Empty), "Erich Gamma is a Swiss computer scientist and co-author of the influential software engineering book 'Design Patterns: Elements of Reusable Object-Oriented Software'."),
                Author.Create(PersonFormalName.Create(["Richard", "Helm"], string.Empty, string.Empty), "Richard Helm is a co-author of the 'Gang of Four' book on Design Patterns and has extensive experience in object-oriented technology and software architecture."),
                Author.Create(PersonFormalName.Create(["Ralph", "Johnson"], "Dr.", string.Empty), "Ralph Johnson is a Research Associate Professor in the Department of Computer Science at the University of Illinois at Urbana-Champaign and a co-author of the 'Gang of Four' Design Patterns book."),
                Author.Create(PersonFormalName.Create(["John", "Vlissides"], string.Empty, string.Empty), "John Vlissides was a software consultant, designer, and implementer with expertise in object-oriented technology and a co-author of Design Patterns."),
                Author.Create(PersonFormalName.Create(["Chris", "Richardson"], string.Empty, string.Empty), "Chris Richardson is a developer and architect. He is a Java Champion, a JavaOne rock star and the author of POJOs in Action, which describes how to build enterprise Java applications with frameworks such as Spring and Hibernate."),
                Author.Create(PersonFormalName.Create(["Grady", "Booch"], string.Empty, string.Empty), "Grady Booch is an American software engineer, best known for developing the Unified Modeling Language with Ivar Jacobson and James Rumbaugh."),
                Author.Create(PersonFormalName.Create(["Ivar", "Jacobson"], "Dr.", string.Empty), "Ivar Jacobson is a Swedish computer scientist and software engineer, known as a major contributor to UML, Objectory, RUP, and Aspect-oriented software development."),
                Author.Create(PersonFormalName.Create(["James", "Rumbaugh"], "Dr.", string.Empty), "James Rumbaugh is an American computer scientist and object-oriented methodologist who is best known for his work in creating the Object Modeling Technique and the Unified Modeling Language."),
                Author.Create(PersonFormalName.Create(["Michael", "Feathers"], string.Empty, string.Empty), "Michael Feathers is a consultant and author in the field of software development. He is a specialist in software testing and process improvement."),
                Author.Create(PersonFormalName.Create(["Brendan", "Burns"], string.Empty, string.Empty), string.Empty),
                Author.Create(PersonFormalName.Create(["George", "Fairbanks"], string.Empty, string.Empty), string.Empty),
                Author.Create(PersonFormalName.Create(["Rebecca", "Parsons"], string.Empty, string.Empty), string.Empty),
                Author.Create(PersonFormalName.Create(["Patrick", "Kua"], string.Empty, string.Empty), string.Empty),
                Author.Create(PersonFormalName.Create(["Pramod", "Sadalage"], string.Empty, string.Empty), string.Empty),
                Author.Create(PersonFormalName.Create(["Paul", "Clements"], string.Empty, string.Empty), string.Empty),
                Author.Create(PersonFormalName.Create(["Felix", "Bachmann"], string.Empty, string.Empty), string.Empty),
                Author.Create(PersonFormalName.Create(["David", "Garlan"], string.Empty, string.Empty), string.Empty),
                Author.Create(PersonFormalName.Create(["James", "Ivers"], string.Empty, string.Empty), string.Empty),
                Author.Create(PersonFormalName.Create(["Reed", "Little"], string.Empty, string.Empty), string.Empty),
                Author.Create(PersonFormalName.Create(["Paulo", "Merson"], string.Empty, string.Empty), string.Empty),
                Author.Create(PersonFormalName.Create(["Robert", "Nord"], string.Empty, string.Empty), string.Empty),
                Author.Create(PersonFormalName.Create(["Judith", "Stafford"], string.Empty, string.Empty), string.Empty),
                Author.Create(PersonFormalName.Create(["Michael", "T.", "Nygard"], string.Empty, string.Empty), string.Empty),
                Author.Create(PersonFormalName.Create(["Martin", "L.", "Abbot"], string.Empty, string.Empty), string.Empty),
                Author.Create(PersonFormalName.Create(["Michael", "T.", "Fisher"], string.Empty, string.Empty), string.Empty),
                Author.Create(PersonFormalName.Create(["Cornelia", "Davies"], string.Empty, string.Empty), string.Empty),
                Author.Create(PersonFormalName.Create(["Martin", "Kleppmann"], string.Empty, string.Empty), string.Empty) // 36
