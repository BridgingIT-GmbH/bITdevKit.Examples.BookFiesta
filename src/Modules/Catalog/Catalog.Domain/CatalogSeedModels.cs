...
public static class CatalogSeedModels
{
    ...
    public static class Authors
    {
        public static Author[] Create(TenantId[] tenants, Tag[] tags, long ticks = 0) =>
            [.. new[]
            {
                ...
                Author.Create(tenants[0], PersonFormalName.Create(["Mark", "Richards"], string.Empty, string.Empty), "Mark Richards is an experienced, hands-on software architect involved in the architecture, design, and implementation of microservices architectures, service-oriented architectures, and distributed systems."),
                Author.Create(tenants[0], PersonFormalName.Create(["Dino", "Esposito"], string.Empty, string.Empty), "Dino Esposito is a well-known web development expert and the author of many popular books on ASP.NET, AJAX, and JavaScript."),
                Author.Create(tenants[0], PersonFormalName.Create(["Len", "Bass"], "Dr.", string.Empty), "Len Bass is a senior principal researcher at National ICT Australia Ltd. He has authored numerous books and articles on software architecture, programming, and product line engineering."),
                Author.Create(tenants[0], PersonFormalName.Create(["Erich", "Gamma"], "Dr.", string.Empty), "Erich Gamma is a Swiss computer scientist and co-author of the influential software engineering book 'Design Patterns: Elements of Reusable Object-Oriented Software'."),
                Author.Create(tenants[0], PersonFormalName.Create(["Richard", "Helm"], string.Empty, string.Empty), "Richard Helm is a co-author of the 'Gang of Four' book on Design Patterns and has extensive experience in object-oriented technology and software architecture."),
                Author.Create(tenants[0], PersonFormalName.Create(["Ralph", "Johnson"], "Dr.", string.Empty), "Ralph Johnson is a Research Associate Professor in the Department of Computer Science at the University of Illinois at Urbana-Champaign and a co-author of the 'Gang of Four' Design Patterns book."),
                Author.Create(tenants[0], PersonFormalName.Create(["John", "Vlissides"], string.Empty, string.Empty), "John Vlissides was a software consultant, designer, and implementer with expertise in object-oriented technology and a co-author of Design Patterns."),
                Author.Create(tenants[0], PersonFormalName.Create(["Chris", "Richardson"], string.Empty, string.Empty), "Chris Richardson is a developer and architect. He is a Java Champion, a JavaOne rock star and the author of POJOs in Action, which describes how to build enterprise Java applications with frameworks such as Spring and Hibernate."),
                Author.Create(tenants[0], PersonFormalName.Create(["Grady", "Booch"], string.Empty, string.Empty), "Grady Booch is an American software engineer, best known for developing the Unified Modeling Language with Ivar Jacobson and James Rumbaugh."),
                Author.Create(tenants[0], PersonFormalName.Create(["Ivar", "Jacobson"], "Dr.", string.Empty), "Ivar Jacobson is a Swedish computer scientist and software engineer, known as a major contributor to UML, Objectory, RUP, and Aspect-oriented software development."),
                Author.Create(tenants[0], PersonFormalName.Create(["James", "Rumbaugh"], "Dr.", string.Empty), "James Rumbaugh is an American computer scientist and object-oriented methodologist who is best known for his work in creating the Object Modeling Technique and the Unified Modeling Language."),
                Author.Create(tenants[0], PersonFormalName.Create(["Michael", "Feathers"], string.Empty, string.Empty), "Michael Feathers is a consultant and author in the field of software development. He is a specialist in software testing and process improvement."),
                Author.Create(tenants[0], PersonFormalName.Create(["Brendan", "Burns"], string.Empty, string.Empty), string.Empty),
                Author.Create(tenants[0], PersonFormalName.Create(["George", "Fairbanks"], string.Empty, string.Empty), string.Empty),
                Author.Create(tenants[0], PersonFormalName.Create(["Rebecca", "Parsons"], string.Empty, string.Empty), string.Empty),
                Author.Create(tenants[0], PersonFormalName.Create(["Patrick", "Kua"], string.Empty, string.Empty), string.Empty),
                Author.Create(tenants[0], PersonFormalName.Create(["Pramod", "Sadalage"], string.Empty, string.Empty), string.Empty),
                Author.Create(tenants[0], PersonFormalName.Create(["Paul", "Clements"], string.Empty, string.Empty), string.Empty),
                Author.Create(tenants[0], PersonFormalName.Create(["Felix", "Bachmann"], string.Empty, string.Empty), string.Empty),
                Author.Create(tenants[0], PersonFormalName.Create(["David", "Garlan"], string.Empty, string.Empty), string.Empty),
                Author.Create(tenants[0], PersonFormalName.Create(["James", "Ivers"], string.Empty, string.Empty), string.Empty),
                Author.Create(tenants[0], PersonFormalName.Create(["Reed", "Little"], string.Empty, string.Empty), string.Empty),
                Author.Create(tenants[0], PersonFormalName.Create(["Paulo", "Merson"], string.Empty, string.Empty), string.Empty),
                Author.Create(tenants[0], PersonFormalName.Create(["Robert", "Nord"], string.Empty, string.Empty), string.Empty),
                Author.Create(tenants[0], PersonFormalName.Create(["Judith", "Stafford"], string.Empty, string.Empty), string.Empty),
                Author.Create(tenants[0], PersonFormalName.Create(["Michael", "T.", "Nygard"], string.Empty, string.Empty), string.Empty),
                Author.Create(tenants[0], PersonFormalName.Create(["Martin", "L.", "Abbot"], string.Empty, string.Empty), string.Empty),
                Author.Create(tenants[0], PersonFormalName.Create(["Michael", "T.", "Fisher"], string.Empty, string.Empty), string.Empty),
                Author.Create(tenants[0], PersonFormalName.Create(["Cornelia", "Davies"], string.Empty, string.Empty), string.Empty),
                Author.Create(tenants[0], PersonFormalName.Create(["Martin", "Kleppmann"], string.Empty, string.Empty), string.Empty) // 36
    ...
    public static class Publishers
    {
        public static Publisher[] Create(TenantId[] tenants, long ticks = 0) =>
            [.. new[]
            {
                Publisher.Create(tenants[0], $"Addison-Wesley Professional{GetSuffix(ticks)}", "Addison-Wesley Professional is a publisher of textbooks and computer literature. It is an imprint of Pearson PLC, a global publishing and education company."),
                Publisher.Create(tenants[0], $"O'Reilly Media{GetSuffix(ticks)}", "O'Reilly Media is an American learning company established by Tim O'Reilly that publishes books, produces tech conferences, and provides an online learning platform."),
                Publisher.Create(tenants[0], $"Manning Publications{GetSuffix(ticks)}", "Manning Publications is an American publisher established in 1993 that specializes in computer books for software developers, engineers, architects, system administrators, and managers."),
                Publisher.Create(tenants[0], $"Packt Publishing{GetSuffix(ticks)}", "Packt Publishing is a publisher of technology books, eBooks and video courses for IT developers, administrators, and users."),
    ...
    public static class Categories
    {
        public static Category[] Create(TenantId[] tenants, long ticks = 0) =>
            [.. new[]
            {
                Category.Create(tenants[0], $"Software-Architecture{GetSuffix(ticks)}", "Software Architecture", 0)
                    .AddChild(Category.Create(tenants[0], $"Design-Patterns{GetSuffix(ticks)}", "Design Patterns", 0))
                    .AddChild(Category.Create(tenants[0], $"Architectural-Styles{GetSuffix(ticks)}", "Architectural Styles", 1)
                        .AddChild(Category.Create(tenants[0], $"Microservices{GetSuffix(ticks)}", "Microservices Architecture", 0))
                        .AddChild(Category.Create(tenants[0], $"SOA{GetSuffix(ticks)}", "Service-Oriented Architecture", 1)))
                    .AddChild(Category.Create(tenants[0], $"Domain-Driven-Design{GetSuffix(ticks)}", "Domain-Driven Design", 2)),
                Category.Create(tenants[0], $"Enterprise-Architecture{GetSuffix(ticks)}", "Enterprise Architecture", 1)
                    .AddChild(Category.Create(tenants[0], $"Cloud-Architecture{GetSuffix(ticks)}", "Cloud Architecture", 0))
                    .AddChild(Category.Create(tenants[0], $"Integration-Patterns{GetSuffix(ticks)}", "Integration Patterns", 1)),
                Category.Create(tenants[0], $"Software-Design{GetSuffix(ticks)}", "Software Design", 2)
                    .AddChild(Category.Create(tenants[0], $"Clean-Architecture{GetSuffix(ticks)}", "Clean Architecture", 0))
                    .AddChild(Category.Create(tenants[0], $"SOLID-Principles{GetSuffix(ticks)}", "SOLID Principles", 1)),
                Category.Create(tenants[0], $"Architectural-Practices{GetSuffix(ticks)}", "Architectural Practices", 3)
                    .AddChild(Category.Create(tenants[0], $"Scalability{GetSuffix(ticks)}", "Scalability", 0))
    ...
    {
        public static Book[] Create(TenantId[] tenants, Tag[] tags, Category[] categories, Publisher[] publishers, Author[] authors, long ticks = 0) =>
            [.. new[]
            {
                Book.Create(
                    tenants[0],
