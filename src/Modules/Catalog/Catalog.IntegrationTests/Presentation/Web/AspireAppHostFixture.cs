...
// public class AspireAppHostFixture<TEntryPoint> // https://xunit.net/docs/shared-context#class-fixture
...
//     public AspireAppHostFixture<TEntryPoint> WithOutput(ITestOutputHelper output)
//     {
//         this.Output = output;
//
//         return this;
...
//     /// <returns>Returns the current instance of AspireApphostFactory for method chaining.</returns>
//     public AspireAppHostFixture<TEntryPoint> WithEnvironment(string environment)
//     {
...
//     public AspireAppHostFixture<TEntryPoint> WithFakeAuthentication(bool enabled)
//     {
...
//     public AspireAppHostFixture<TEntryPoint> WithServices(Action<IServiceCollection> action)
//     {
...
//             (options, settings) =>
//             {
//                 options.AssemblyName = typeof(TEntryPoint).Assembly.GetName().Name;
...
//         {
//             await resourceNotificationService.WaitForResourceAsync("presentation-web-server", KnownResourceStates.Running).WaitAsync(TimeSpan.FromSeconds(59));
//         }
//
...
//     // {
//     //         return this.app.CreateHttpClient("presentation-web-server");
//     // }
//
...
//     //     }
//     //
//     //     Log.Logger = loggerConfiguration.CreateLogger().ForContext<AspireAppHostFixture<TEntryPoint>>();
//     //
