...
public class StockUpdatedMessageHandler(ILoggerFactory loggerFactory)
    : MessageHandlerBase<StockUpdatedMessage>(loggerFactory)
{
    public override Task Handle(StockUpdatedMessage message, CancellationToken cancellationToken)
    {
