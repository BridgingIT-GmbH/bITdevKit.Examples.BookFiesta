...
public class TenantSubscriptionPlanType(
    int id,
    string value,
    string code,
    string description,
...
{
    public static TenantSubscriptionPlanType Free = new(
        0,
        nameof(Free),
        "FRE",
        "Lorem Ipsum",
    ...
    public static TenantSubscriptionPlanType Basic = new(
        1,
        nameof(Basic),
        "BAS",
        "Lorem Ipsum",
    ...
    public static TenantSubscriptionPlanType Premium = new(
        2,
        nameof(Premium),
        "PRM",
        "Lorem Ipsum",
