...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BridgingIT.DevKit.Examples.BookFiesta.Organization.Domain.Company", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("BridgingIT.DevKit.Examples.BookFiesta.Organization.Domain.Tenant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BridgingIT.DevKit.Examples.BookFiesta.Organization.Domain.TenantBranding", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BridgingIT.DevKit.Examples.BookFiesta.Organization.Domain.Tenant", b =>
                {
                    b.HasOne("BridgingIT.DevKit.Examples.BookFiesta.Organization.Domain.Company", null)
                        .WithMany()
                        .HasForeignKey("CompanyId")
                    ...
                    b.OwnsMany("BridgingIT.DevKit.Examples.BookFiesta.Organization.Domain.TenantSubscription", "Subscriptions", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BridgingIT.DevKit.Examples.BookFiesta.Organization.Domain.TenantBranding", b =>
                {
                    b.HasOne("BridgingIT.DevKit.Examples.BookFiesta.Organization.Domain.Tenant", null)
                        .WithOne("Branding")
                        .HasForeignKey("BridgingIT.DevKit.Examples.BookFiesta.Organization.Domain.TenantBranding", "TenantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
